...
const navigation = {
    social: [
      {
        name: 'Instagram',
        href: 'https://www.instagram.com/GDGCoimbatore/',
        icon: (props) => (
      ...
      {
        name: 'Twitter',
        href: 'https://www.twitter.com/GDGCoimbatore/',
        icon: (props) => (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
      ...
      {
        name: 'Facebook',
        href: 'https://www.facebook.com/GDGCoimbatore/',
        icon: (props) => (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
            <path
              fillRule="evenodd"
  ...
  return (
    <footer className="py-16">
      <Container className="flex flex-col items-center justify-between md:flex-row">
        ...
        <div className="px-4 mt-6 mb-6 space-y-6">
        <p className="mb-6 text-lg tracking-tighter text-gray-800 font-display">
